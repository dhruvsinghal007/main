----------------HelloWorld Student Details Application in Extjs----------------------
...
Instructions :
	1. To run the application :
		...
		c. Open any browser and type the following url : http://localhost:8080/HelloWorld/index.html
	The grid automatically loads data.
	
	2. To diagnose :
		a. Copy the eclipse project folder (HelloWorld) and paste into workspace directory of eclipse.
