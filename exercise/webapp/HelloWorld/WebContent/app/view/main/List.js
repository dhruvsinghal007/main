		...
		Ext.apply(this,{
			...
			bbar : [
			{
				...
				handler : function(){
					...
					Ext.Ajax.request({
						url : 'http://localhost:8080/HelloWorld/accounts/add',
						method : 'POST',
						jsonData : {
						...
						Ext.Msg.show({
							...
							fn : function(buttonValue, inputText, showConfig){
								if(buttonValue === 'yes'){
									...
									Ext.Ajax.request({
										url : 'http://localhost:8080/HelloWorld/accounts/multiUpdate',
										method : 'PUT',
										jsonData : data,
										success : function(response,request){
						...
						Ext.Msg.show({
							...
							fn : function(buttonValue, inputText, showConfig){
								if(buttonValue === 'yes'){
									...
									Ext.Ajax.request({
										url : 'http://localhost:8080/HelloWorld/accounts/multiDelete',
										method : 'PUT',
										jsonData : data,
										success : function(response,request){
